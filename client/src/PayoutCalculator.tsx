...
const PayoutCalculator: React.FC<PayoutCalculatorProps> = ({ totalBalance }) => {
  ...
  return (
    <Box>
      <Flex direction="row" justify="center" align="center" my={4}>
        <Box background={"#16182e"} borderWidth="1px" borderRadius="lg" overflow="hidden" p={4} boxShadow="lg" mx={2}>
          <Text fontSize={{ base: "xs", md: "sm" }} color="gray.500" textAlign="center">
            Total Made (1w)
          </Text>
          <Text fontSize={{ base: "l", md: "2xl" }} fontWeight="bold" textAlign="center">
      ...
      <Box background={"#16182e"} borderWidth="1px" borderRadius="lg" overflow="hidden" p={4} boxShadow="lg" textAlign="center" marginBottom={4}>
        <Flex direction="row" align="center" justify="center" mb={4}>
          <Text fontSize={{ base: "2xl", md: "50px" }} fontWeight="bold">
            1
          </Text>
          <Image className="logo" src="/cat.png" alt="Logo" boxSize="50px" ml={2} mr={2} />
          <Text fontSize={{ base: "2xl", md: "50px" }} fontWeight="bold">
            = {payoutPerNft.toFixed(4)} SOL
          </Text>
        </Flex>
        <Box>
          <Input maxW={400} placeholder="Enter NFTs owned" onChange={(e) => setNftsOwned(Number(e.target.value))} />
        </Box>
        <Text fontSize={{ base: "lg", md: "xl" }} fontWeight="bold" mt={4}>
